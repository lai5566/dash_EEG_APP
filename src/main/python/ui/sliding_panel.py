            ...
            html.Div([
                ...
                html.Div([
                    html.Div([
                        ...
                        html.Div("Manage", style={'writingMode': 'vertical-rl',
                ...
                html.Div([
                    ...
                    html.Div([
                        # 標籤切換
                        html.Div([
                            html.Button("Subject Management", id="subjects-tab-btn",
                            ...
                            html.Button("Audio Management", id="sounds-tab-btn",
                                       ...
                                       style={'flex': '1', 'padding': '12px 16px',
                                             ...
                                             'cursor': 'pointer', 'fontWeight': 'bold',
                                             'borderRadius': '0'}),
                            html.Button("History", id="history-tab-btn",
                                       className="tab-button",
                                       style={'flex': '1', 'padding': '12px 16px',
                                             'border': 'none', 'backgroundColor': '#95a5a6',
                                             'color': 'white', 'fontSize': '13px',
                                ...
                                html.Div([
                                    ...
                                    html.Div([
                                        ...
                                        dcc.Input(
                                            ...
                                            type="text",
                                            placeholder="e.g.: Forest White Noise, Baby Crying",
                                            style={'width': '100%', 'padding': '14px 16px',
                                                  'marginBottom': '20px', 'fontSize': '15px',
                                                  'border': '2px solid #e2e8f0',
                                                  'borderRadius': '12px', 'background': 'white',
